...
<title>OWASP ZAP Test WebApp - Http Authentication -
	Authenticated</title>
</head>
<body>
	...
	<p>
		You can visit <a href="a.jsp">this page.</a>
	</p>

	<p>
		Or you can visit <a href="b.jsp">this other page.</a>
	</p>
	<p>
		Back <a href="../index.jsp">Home</a>
	</p>
	<p>Unique Identifier usable in tests: http-restricted-home-872642</p>
