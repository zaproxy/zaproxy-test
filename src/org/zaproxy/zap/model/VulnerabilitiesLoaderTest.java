...
public class VulnerabilitiesLoaderTest {
	
	public VulnerabilitiesLoader loader;
	
	@Test
	public void LoadVulnerabilities() {
		loader = new VulnerabilitiesLoader("src/resource/vulnerabilities/", "vulnerabilities-test");
	...
	public void LoadVulnerabilitiesWithError() {
		loader = new VulnerabilitiesLoader("src/resource/vulnerabilities/", "vulnerabilities-error");
		VulnerabilitiesI18NMap map = loader.load();
	}
}
